...
const playSongAtIndex = (index) => {
    ...
    audio.play().then(() => dispatch({ type: 'PLAY' })).catch((error) => console.error("Playback failed:", error));
};
...
const handlePrev=() =>{
 ...
 const handleTogggleLoop =() =>{
    dispatch({type: "TOGGLE_LOOP"});
}
const handleTogggleShuffle =() =>{
